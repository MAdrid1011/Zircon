...
module Order_Issue_Queue(
  ...
  wire [1:0]  _tail_T = qmask[2] ? 2'h0 : insert_num;
  wire [3:0]  _qmask_pop_T_1 = {1'h0, qmask[3:1]};
  wire [3:0]  qmask_pop = io_issue_ack ? _qmask_pop_T_1 : qmask;
  wire [2:0]  _tail_pop_T = 3'(tail - {2'h0, io_issue_ack});
  ...
  wire [5:0]  queue_next_3_inst_prj = qmask_pop[3] ? queue_3_inst_prj : _GEN_9;
  wire [5:0]  queue_next_3_inst_prk = qmask_pop[3] ? queue_3_inst_prk : _GEN_10;
  wire        _GEN_11 = _GEN ? io_prj_ready_1 : io_prj_ready_0;
  wire        _queue_next_T_prj_waked =
    io_issue_ack ? queue_1_prj_waked : queue_0_prj_waked;
  wire        queue_next_prj_waked = qmask_pop[0] ? _queue_next_T_prj_waked : _GEN_11;
  wire        _GEN_12 = _GEN ? io_prk_ready_1 : io_prk_ready_0;
  wire        _queue_next_T_prk_waked =
    io_issue_ack ? queue_1_prk_waked : queue_0_prk_waked;
  wire        queue_next_prk_waked = qmask_pop[0] ? _queue_next_T_prk_waked : _GEN_12;
  ...
  wire        queue_next_prk_wake_by_ld =
    qmask_pop[0]
      ? _queue_next_T_prk_wake_by_ld
      : (queue_next_inst_prk ^ io_ld_mem_prd) == 6'h0 & (|io_ld_mem_prd);
  wire        _GEN_13 = _GEN_2 ? io_prj_ready_1 : io_prj_ready_0;
  wire        _queue_next_T_1_prj_waked =
    io_issue_ack ? queue_2_prj_waked : queue_1_prj_waked;
  wire        queue_next_1_prj_waked = qmask_pop[1] ? _queue_next_T_1_prj_waked : _GEN_13;
  wire        _GEN_14 = _GEN_2 ? io_prk_ready_1 : io_prk_ready_0;
  wire        _queue_next_T_1_prk_waked =
    io_issue_ack ? queue_2_prk_waked : queue_1_prk_waked;
  wire        queue_next_1_prk_waked = qmask_pop[1] ? _queue_next_T_1_prk_waked : _GEN_14;
  ...
  wire        _GEN_15 = _GEN_5 ? io_prj_ready_1 : io_prj_ready_0;
  wire        _queue_next_T_2_prj_waked =
    io_issue_ack ? queue_3_prj_waked : queue_2_prj_waked;
  wire        queue_next_2_prj_waked = qmask_pop[2] ? _queue_next_T_2_prj_waked : _GEN_15;
  wire        _GEN_16 = _GEN_5 ? io_prk_ready_1 : io_prk_ready_0;
  wire        _queue_next_T_2_prk_waked =
    io_issue_ack ? queue_3_prk_waked : queue_2_prk_waked;
  wire        queue_next_2_prk_waked = qmask_pop[2] ? _queue_next_T_2_prk_waked : _GEN_16;
  ...
  wire        queue_next_2_prj_wake_by_ld =
    qmask_pop[2]
      ? _queue_next_T_2_prj_wake_by_ld
  ...
  wire        queue_next_2_prk_wake_by_ld =
    qmask_pop[2]
      ? _queue_next_T_2_prk_wake_by_ld
      : (queue_next_2_inst_prk ^ io_ld_mem_prd) == 6'h0 & (|io_ld_mem_prd);
  wire        _GEN_17 = _GEN_8 ? io_prj_ready_1 : io_prj_ready_0;
  wire        queue_next_3_prj_waked = qmask_pop[3] ? queue_3_prj_waked : _GEN_17;
  wire        _GEN_18 = _GEN_8 ? io_prk_ready_1 : io_prk_ready_0;
  wire        queue_next_3_prk_waked = qmask_pop[3] ? queue_3_prk_waked : _GEN_18;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (io_flush) begin
        ...
        tail <= 3'(_tail_pop_T + {1'h0, _tail_T});
        if (insert_num == 2'h2)
          qmask <= {qmask_pop[1:0], 2'h3};
        else if (insert_num == 2'h1)
          qmask <= {qmask_pop[2:0], 1'h1};

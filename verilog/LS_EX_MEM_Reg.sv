...
module LS_EX_MEM_Reg(
  ...
  wire        _GEN = io_stall ? inst_pack_reg_rd_valid : io_inst_pack_EX_rd_valid;
  wire        _GEN_0 = io_stall ? inst_pack_reg_inst_valid : io_inst_pack_EX_inst_valid;
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (io_flush) begin
        ...
        prd_reg_0 <= io_prd_EX_0;
        prd_reg_1 <= io_prd_EX_1;
  ...
  assign io_prd_MEM_0 = prd_reg_0;
  assign io_prd_MEM_1 = prd_reg_1;

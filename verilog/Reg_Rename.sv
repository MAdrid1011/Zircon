...
module Reg_Rename(
  ...
  wire       _GEN = io_rd_valid_0 & (io_rd_0 ^ io_rj_1) == 5'h0;
  assign prj_nraw_1 = ~_GEN;
  wire       _GEN_0 = io_rd_valid_0 & (io_rd_0 ^ io_rk_1) == 5'h0;
  assign prk_nraw_1 = ~_GEN_0;
  wire [4:0] _rd_valid_temp_0_T = io_rd_0 ^ io_rd_1;
  assign _crat_io_rd_valid_0 =
    io_rd_valid_0 & ~(~(|_rd_valid_temp_0_T) & io_rd_valid_1) & io_rename_en_0;
  ...
  assign io_prj_1 = _GEN ? io_alloc_preg_0 : _crat_io_prj_1;
  assign io_prk_1 = _GEN_0 ? io_alloc_preg_0 : _crat_io_prk_1;
  assign io_prd_0 = io_alloc_preg_0;
  assign io_prd_1 = io_alloc_preg_1;
  assign io_pprd_1 =
    io_rd_valid_0 & ~(|_rd_valid_temp_0_T) ? io_alloc_preg_0 : _crat_io_pprd_1;
  assign io_prj_ready_1 = _crat_io_prj_ready_1 & prj_nraw_1;
  assign io_prk_ready_1 = _crat_io_prk_ready_1 & prk_nraw_1;
endmodule

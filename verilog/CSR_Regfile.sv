...
module CSR_Regfile(
  ...
  wire [31:0] _GEN_14 = io_raddr == 14'h33 ? save3 : _GEN_13;
  wire [31:0] _GEN_15 = io_raddr == 14'h32 ? save2 : _GEN_14;
  wire [31:0] _GEN_16 = io_raddr == 14'h31 ? save1 : _GEN_15;
  wire [31:0] _GEN_17 = io_raddr == 14'h30 ? save0 : _GEN_16;
  wire [31:0] _GEN_18 = io_raddr == 14'h20 ? cpuid : _GEN_17;
  ...
  wire [30:0] _GEN_26 =
    io_we & io_waddr == 14'h5
      ? {estat[30:16], 4'h0, timer_int_reg, 9'h0, io_wdata[1:0]}
      : {estat[30:16], 4'h0, timer_int_reg, 9'h0, estat[1:0]};
  ...
  wire        vppn_save = is_tlbr | (|(io_exception[6:0])) & io_exception[6:0] < 7'h8;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      timer_int_reg <=
        ...
        & (tcfg[0] & _GEN_27 & tval_edge == 32'h1 | timer_int_reg);
      if (io_exception[7]) begin
        crmd <= {crmd[31:5], _crmd_T_2, 3'h0};
        prmd <= {prmd[31:3], crmd[2:0]};
        estat <= {estat[31], 8'h0, io_exception[6:0], estat[15:0]};
        era <= io_pc_exp;
      end
      else begin
        if (io_is_eret)
      ...
      if (io_exception[7]
          & (vppn_save | io_exception[5:0] == 6'h8 | io_exception[6:0] == 7'h9))
        badv <= io_badv_exp;

...
module MMU(
  ...
  wire        _io_i_uncache_T_6 = i_dmw1_hit ? ~(i_csr_dmw1[4]) : _tlb_io_i_uncache;
  wire        _io_i_uncache_T_7 = i_dmw0_hit ? ~(i_csr_dmw0[4]) : _io_i_uncache_T_6;
  reg         i_exception_ne;
  reg  [31:0] d_csr_dmw0;
  reg  [31:0] d_csr_dmw1;
  reg  [1:0]  d_csr_plv;
  ...
  wire        _io_d_uncache_T_6 = d_dmw1_hit ? ~(d_csr_dmw1[4]) : _tlb_io_d_uncache;
  ...
  TLB tlb (
    ...
    .io_tlbrd_entry_vppn (io_tlbrd_entry_vppn),
    .io_tlbrd_entry_ps   (io_tlbrd_entry_ps),
    .io_tlbrd_entry_g    (io_tlbrd_entry_g),
    .io_tlbrd_entry_asid (io_tlbrd_entry_asid),
    .io_tlbrd_entry_e    (io_tlbrd_entry_e),
    .io_tlbrd_entry_ppn0 (io_tlbrd_entry_ppn0),
    .io_tlbrd_entry_plv0 (io_tlbrd_entry_plv0),
    .io_tlbrd_entry_mat0 (io_tlbrd_entry_mat0),
    .io_tlbrd_entry_d0   (io_tlbrd_entry_d0),
    .io_tlbrd_entry_v0   (io_tlbrd_entry_v0),
    .io_tlbrd_entry_ppn1 (io_tlbrd_entry_ppn1),
    .io_tlbrd_entry_plv1 (io_tlbrd_entry_plv1),
    .io_tlbrd_entry_mat1 (io_tlbrd_entry_mat1),
    .io_tlbrd_entry_d1   (io_tlbrd_entry_d1),
    .io_tlbrd_entry_v1   (io_tlbrd_entry_v1),
    ...
    .io_i_uncache        (_tlb_io_i_uncache),

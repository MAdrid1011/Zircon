...
module PC(
  ...
  reg  [31:0] pc_9;
  reg         idle_en;
  wire        _inst_valid_temp_T = idle_en | io_has_csr_change;
  wire [1:0]  _GEN = {io_pred_jump_1, io_pred_jump_0};
  wire [31:0] _io_npc_0_T = 32'(pc_0 + 32'h8);
  wire [31:0] _io_npc_0_T_3 = {_io_npc_0_T[31:3], 3'h0};
  wire [31:0] _GEN_0 = (|_GEN) ? io_pred_npc : _io_npc_0_T_3;
  wire [31:0] _GEN_1 = io_pc_stall ? pc_0 : _GEN_0;
  wire [31:0] _GEN_2 = io_flush_by_pd ? io_flush_pd_target : _GEN_1;
  wire [31:0] _GEN_3 = io_predict_fail ? io_branch_target : _GEN_2;
  wire [31:0] _io_npc_1_T = 32'(pc_1 + 32'h8);
  wire [31:0] _io_npc_1_T_3 = {_io_npc_1_T[31:3], 3'h0};
  wire [31:0] _GEN_4 = (|_GEN) ? io_pred_npc : _io_npc_1_T_3;
  wire [31:0] _GEN_5 = io_pc_stall ? pc_1 : _GEN_4;
  wire [31:0] _GEN_6 = io_flush_by_pd ? io_flush_pd_target : _GEN_5;
  wire [31:0] _GEN_7 = io_predict_fail ? io_branch_target : _GEN_6;
  wire [1:0]  inst_valid_temp = _inst_valid_temp_T ? 2'h0 : {~io_pred_jump_0, 1'h1};
  ...
  wire        _GEN_8 = idle_en ? idle_en : io_is_idle_cmt;
  ...
  assign io_npc_0 = _inst_valid_temp_T ? pc_0 : _GEN_3;
  assign io_npc_1 = _inst_valid_temp_T ? pc_1 : _GEN_7;
  assign io_inst_valid_PF_0 = inst_valid_temp[0];
  assign io_inst_valid_PF_1 = inst_valid_temp[1] & ~(pc_0[2]);
  assign io_exception_PF = pc_0[1:0] == 2'h0 ? 8'h0 : 8'h88;
endmodule
